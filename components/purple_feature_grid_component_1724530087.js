    ...
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container">
                <p id="feature-1-description" class="flex-1 text-sm">Browse through a wide variety of toilet paper brands, textures, and sizes to find your perfect roll.</p>
            </div>
        </div>
        ...
        <div id="feature-2">
            <div id="feature-2-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-2-title-container">
                    <h4 id="feature-2-title" class="flex-1 text-slate-50 font-medium">Bulk Buying Options</h4>
                </div>
            </div>
            <div class="flex" id="feature-2-description-container">
                <p id="feature-2-description" class="flex-1 text-sm">Save money and stock up with our convenient bulk purchasing options for households and businesses.</p>
            </div>
        </div>
        ...
        <div id="feature-3">
            <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-3-title-container">
                    <h4 id="feature-3-title" class="flex-1 text-slate-50 font-medium">Eco-Friendly Choices</h4>
                </div>
            </div>
            <div class="flex" id="feature-3-description-container">
                <p id="feature-3-description" class="flex-1 text-sm">Explore our range of sustainable and environmentally-friendly toilet paper options for conscious consumers.</p>
            </div>
        </div>
        ...
        <div id="feature-4">
            ...
            <div class="flex" id="feature-4-description-container">
                <p id="feature-4-description" class="flex-1 text-sm">Make informed decisions with genuine user reviews and ratings for each product in our marketplace.</p>
            </div>
        </div>
        ...
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container">
                <p id="feature-5-description" class="flex-1 text-sm">Never run out of toilet paper again with our flexible subscription plans for regular deliveries.</p>
            </div>
        </div>
        ...
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container">
                    <h4 id="feature-6-title" class="flex-1 text-slate-50 font-medium">Competitive Pricing</h4>
                </div>
            </div>
            <div class="flex" id="feature-6-description-container">
                <p id="feature-6-description" class="flex-1 text-sm">Compare prices across multiple brands and sellers to ensure you're getting the best deal on your toilet paper purchases.</p>
            </div>
        </div>
    </div>
</template>
